...
| Platform | |
|---|---|
| macOS — Apple Silicon | [LiveCut-1.0.3-arm64.dmg](https://github.com/chrissabato/livecut/releases/download/desktop-v1.0.3/LiveCut-1.0.3-arm64.dmg) |
| macOS — Intel | [LiveCut-1.0.3-x64.dmg](https://github.com/chrissabato/livecut/releases/download/desktop-v1.0.3/LiveCut-1.0.3-x64.dmg) |
| Windows — x64 | [LiveCut-1.0.3-x64.exe](https://github.com/chrissabato/livecut/releases/download/desktop-v1.0.3/LiveCut-1.0.3-x64.exe) |
| Windows — ARM64 | [LiveCut-1.0.3-arm64.exe](https://github.com/chrissabato/livecut/releases/download/desktop-v1.0.3/LiveCut-1.0.3-arm64.exe) |
