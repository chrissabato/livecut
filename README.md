...
| Platform | |
|---|---|
| macOS — Apple Silicon | [LiveCut-1.0.2-arm64.dmg](https://github.com/chrissabato/livecut/releases/download/desktop-v1.0.2/LiveCut-1.0.2-arm64.dmg) |
| macOS — Intel | [LiveCut-1.0.2-x64.dmg](https://github.com/chrissabato/livecut/releases/download/desktop-v1.0.2/LiveCut-1.0.2-x64.dmg) |
| Windows — x64 | [LiveCut-1.0.2-x64.exe](https://github.com/chrissabato/livecut/releases/download/desktop-v1.0.2/LiveCut-1.0.2-x64.exe) |
| Windows — ARM64 | [LiveCut-1.0.2-arm64.exe](https://github.com/chrissabato/livecut/releases/download/desktop-v1.0.2/LiveCut-1.0.2-arm64.exe) |

All builds, notes, and older versions: [releases page](https://github.com/chrissabato/livecut/releases) (`desktop-v*` tags).

<!-- MAINTAINER: these are hard links to a specific release. When you publish a new
     desktop-v* release, bump the version in the table above and in
     DESKTOP_RELEASE_TAG in src/App.tsx. -->
